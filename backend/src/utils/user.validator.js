...
const updateProfileSchema = Joi.object({
  ...
  work_location: Joi.string().trim().max(255).allow('', null).optional(),
  work_hours: Joi.string().trim().max(100).allow('', null).optional(),
  days_per_week: Joi.number().integer().min(0).max(7).allow(null).optional(),
