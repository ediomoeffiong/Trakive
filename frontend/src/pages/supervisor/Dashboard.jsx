    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem', paddingBottom: '3rem' }}>
      ...
      <section className="welcome-banner">
        <div style={{ display: 'flex', flexDirection: 'column', mdDirection: 'row', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1.5rem' }}>
          ...
          {progress && (
            <div style={{ minWidth: '240px', background: 'rgba(255, 255, 255, 0.15)', padding: '1rem', borderRadius: '0.75rem', backdropFilter: 'blur(8px)', border: '1px solid rgba(255, 255, 255, 0.2)' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem', fontSize: '0.8125rem', color: '#ffffff' }}>
              ...
              <div style={{ height: '6px', background: 'rgba(255, 255, 255, 0.25)', borderRadius: '99px', overflow: 'hidden' }}>
                <div style={{ width: `${progress.profileCompletion?.value}%`, height: '100%', background: '#ffffff', transition: 'width 0.8s ease-out' }} />
              </div>
