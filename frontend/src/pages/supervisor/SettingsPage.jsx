/**
 * @file SettingsPage.jsx (Supervisor Portal)
 * @description Supervisor — Portal Settings & Preferences page.
 * Reuses the shared SettingsLayout, SettingsDashboard, and all settings section
 * components with the supervisor role context.
 */
...
const BlockModal = ({ onConfirm, onCancel }) => (
  <div style={{
    ...
    >
      ...
      <h3 style={{
        fontSize: '1.0625rem', fontWeight: 700, color: 'var(--color-neutral-900)',
...
// ── Supervisor Settings Page Component ─────────────────────────────────────────
const SupervisorSettingsPage = () => {
  ...
  // ── Navigation blocker guard for unsaved changes ──────────────────────────
  ...
  const renderSection = () => {
    ...
    if (!SectionComponent) return <SettingsDashboard onNavigate={handleNavigate} />;
  ...
  return (
    ...
    >
      <h1 className="sr-only">Supervisor Portal Settings — Trakive</h1>
