...
import {
  ...
  RiSearchLine, RiMegaphoneLine, RiAlarmLine, RiWifiOffLine,
} from 'react-icons/ri';
          ...
          >
            {error ? (
              <EmptyState
                ...
                description={error}
                action={<button type="button" className="btn btn-primary" onClick={() => fetchAll('Supervisor')}>Try Again</button>}
              />
            ) : (
              <>
