      ...
      >
        <div className="card p-6 profile-about-card" tabIndex={0}>
          ...
          <div style={{ display: 'grid', gap: '0.625rem' }}>
            ...
            <DetailRow label="Role" value={`${profile?.jobTitle || profile?.role || 'Supervisor'}${profile?.department ? ` (${profile.department})` : ''}`} />
        ...
        <div className="card p-6">
          ...
          <div style={{ display: 'grid', gap: '0.75rem' }}>
            <DetailRow label="Supervisor ID" value={profile?.employeeId} />
            <DetailRow label="Role & Tier" value={profile?.role} />
