    ...
    children: [
      {
        ...
        children: [
          ...
          { path: ROUTES.ANALYTICS, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
          { path: ROUTES.ANALYTICS_COMPARE, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
          { path: ROUTES.ANALYTICS_DRILLDOWN, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
          ...
          { path: ROUTES.REPORTS, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
          { path: ROUTES.REPORTS_BUILDER, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
          { path: ROUTES.REPORTS_SAVED, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
          { path: ROUTES.REPORTS_EXPORT, element: <Navigate to={`${ROUTES.REVIEWS}?tab=analytics`} replace /> },
