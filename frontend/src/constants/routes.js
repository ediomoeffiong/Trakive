...
export const ROUTES = {
  ...
  WEEKLY_TASKS: '/dashboard/weekly-tasks',
  ...
  SUPERVISOR_PROJECTS: '/supervisor/projects',
  SUPERVISOR_PROJECT_DETAILS: '/supervisor/projects/:projectId',
  SUPERVISOR_WEEKLY_REVIEW: '/supervisor/weekly-review',
